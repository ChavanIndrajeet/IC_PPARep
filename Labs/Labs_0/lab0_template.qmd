...
Numeric (double) , Character
- Are there any column names that might cause problems? Why?
Some column names use double variable format. This would be a problem as 

**Your answers:**
- Rows: 50,000
- Columns: 7 
- Variable types: Numeric (double) , Character
- Problematic names: Engine Size, Fuel Type, Year of Manufacturing
...
**Your answer:** I did not observe any differences
