...
```{r}
#Filter median age variables by label
median_age <- acs_vars_2022 %>%
  filter(str_detect(label, "Median.*age"))

#Filter median age variables by concept
median_age_1 <- median_age %>%
  filter(str_detect(concept, "Median Age"))

#look at the variables
head (median_age_1)

print("Median age variables:")
head(median_age_1, 5)

print("Median age variables we will use is B01002_001")
...
ggplot(county_data) + 
  aes(x = total_popE) + 
  geom_histogram(bins = 25, fill = "maroon", alpha = 1) +
  labs(
    title = "Distribution of Total Population across Counties",
    x = "Total Population",
    y = "Number of Counties") +
  theme_get() + 
...
ggplot(county_data) + 
  aes(x = total_popE) + 
  geom_histogram(bins = 25, fill = "purple", alpha = 1) +
  labs(
    title = "Distribution of Total Population across Counties",
    x = "Total Population",
    y = "Number of Counties") +
...
ggplot(county_data) + 
  ...
  labs(
    title = "Total Population Distribution with Outliers across Counties",
    y = "Total Population") +
  theme_light() + 
